#!/usr/bin/env python3
"""Inspect only the installed bundled Gallery app. Use the Mac inspector-venv."""
...
async def main():
    ...
    try:
        ...
        candidates=[p for p in pages if p.application.bundle in args.host_bundle and p.page.web_url.startswith('gallery://app/')]
